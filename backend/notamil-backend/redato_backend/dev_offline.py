...
# D12 (ADENDO_B2C_REDATO.md §6): o grader completo foi movido pra
# `redato_backend/grading/essay.py`. Re-exportado aqui pra back-compat
# com os call-sites e testes que ainda importam `_claude_grade_essay`
# deste módulo (bot OF14, portal reprocessar, scripts de eval/smoke,
# e os testes de getsource). A plumbing de baixo nível
# (_call_claude_with_tool, _run_self_critique, _derive_notas_mechanically,
# _persist_grading_to_bq) continua definida NESTE módulo, logo abaixo.
from redato_backend.grading.essay import (  # noqa: E402
    _claude_grade_essay,
